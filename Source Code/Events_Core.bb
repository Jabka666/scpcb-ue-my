				...
				Else
					...
					Select e\EventState
						Case 1.0
							...
							If EntityDistanceSquared(me\Collider, e\room\Objects[0]) < 6.25 And (Not (chs\NoTarget Lor I_268\InvisibilityOn))
						...
						Case 3.0
							...
							If e\EventState2 = 0.0 And I_427\Using Then e\EventState3 = 1.0
							;[End Block]
						Case 4.0
							;[Block]
							Animate2(e\room\Objects[0], AnimTime(e\room\Objects[0]), 2.0, 395.0, 1.0)
					...
					If e\EventState3 = 1.0 And e\EventState2 = 0.0
						If (Not EntityInView(e\room\Objects[0], Camera))
							FreeEntity(e\room\Objects[0]) : e\room\Objects[0] = 0
							RemoveEvent(e)
						EndIf
