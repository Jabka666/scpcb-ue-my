...
Const e_room2_checkpoint% = 26
Const e_room2_cafeteria% = 27
Const e_room2_closets% = 28
Const e_room2_6_lcz_173% = 29
Const e_room2c_ec% = 30
Const e_room2c_gw_lcz_173% = 31, e_room2c_gw_ez_096% = 32
Const e_room2_elevator% = 33
Const e_room2_ic% = 34
Const e_room2_2_lcz% = 35
Const e_room2_nuke% = 36
Const e_room2_2_ez% = 37, e_room2_ez_035% = 38
Const e_room2_medibay% = 39
Const e_room2_shaft% = 40
Const e_room2_tesla% = 41
Const e_room2_mt% = 42
Const e_room2_scientists_2% = 43
Const e_room2_servers_hcz% = 44
Const e_room2_storage% = 45
Const e_room2_2_hcz_106% = 46
Const e_room2_4_hcz_106% = 47, e_room2_4_hcz% = 48
Const e_room2_5_hcz_106% = 49
Const e_room2_6_hcz_smoke% = 50, e_room2_6_hcz% = 51
Const e_room2_test_hcz% = 52, e_room2_test_lcz_173% = 53
Const e_room2_gw_2% = 54, e_gateway% = 55
Const e_room2_sl% = 56
Const e_door_closing% = 57
Const e_room3_storage% = 58
Const e_room3_2_hcz% = 59
Const e_room3_hcz_duck% = 60, e_room3_hcz_1048% = 61
Const e_room3_2_ez% = 62, e_room3_2_ez_duck% = 63
Const e_106_victim% = 64
Const e_106_sinkhole% = 65
Const e_room4_2_hcz% = 66
Const e_096_spawn% = 67
Const e_room4_ic% = 68
Const e_room4_lcz_049% = 69
Const e_dimension_106% = 70
Const e_dimension_1499% = 71
		...
		Select e\EventID
			Case e_cont1_173
				...
				If e\EventState = 0.0
					If PlayerRoom = e\room
						...
						If e\room\NPC[0] = Null
							TFormPoint(3512.0, 820.0, 2634.0, e\room\OBJ, 0)
						...
						If e\EventState2 = 0.0
							If e\EventState > 900.0 And e\room\RoomDoors[3]\Open
								If e\EventState - fps\Factor[0] <= 900.0 
									...
									e\room\NPC[1]\SoundCHN = PlaySound2(e\room\NPC[1]\Sound, Camera, e\room\NPC[1]\Collider, 10.0, 1.0, True)
									e\room\NPC[2]\Sound = LoadSound_Strict("SFX\Room\Intro\WhatThe1b.ogg")
									e\room\NPC[2]\SoundCHN = PlaySound2(e\room\NPC[2]\Sound, Camera, e\room\NPC[2]\Collider, 10.0, 1.0, True)
								EndIf
			...
			Case e_cont1_173_intro
				...
				If PlayerRoom = e\room
					...
					CanSave = 1
					If (Not me\Terminated) And e\EventState2 = 0.0
						If e\EventState = 0.0
							For i = 0 To 1
						...
						If e\EventState3 > 0.0
							...
							ElseIf e\EventState3 >= 150.0 And e\EventState3 < 700.0
								If e\room\NPC[3]\State = 7.0
									If e\room\NPC[3]\Sound2 = 0
										e\room\NPC[3]\Sound2 = LoadSound_Strict("SFX\Room\Intro\Guard\Ulgrin\BeforeDoorOpen.ogg")
										e\room\NPC[3]\SoundCHN2 = PlaySound2(e\room\NPC[3]\Sound2, Camera, e\room\NPC[3]\Collider, 10.0, 1.0, True)
									EndIf
									UpdateSoundOrigin(e\room\NPC[3]\SoundCHN2, Camera, e\room\NPC[3]\Collider, 10.0, 1.0, True)
								...
								If e\room\NPC[5]\State <> 11.0
									If EntityDistanceSquared(e\room\NPC[3]\Collider, e\room\NPC[5]\Collider) > 25.0 And EntityDistanceSquared(e\room\NPC[4]\Collider, e\room\NPC[5]\Collider)
										If EntityDistanceSquared(e\room\NPC[5]\Collider, me\Collider) < 12.25
											...
											Next
											e\room\NPC[5]\SoundCHN2 = PlaySound2(e\room\NPC[5]\Sound2, Camera, e\room\NPC[5]\Collider, 10.0, 1.0, True)
										EndIf
									EndIf
								EndIf
							ElseIf e\EventState3 < 900.0
								...
								If e\room\NPC[8] <> Null Lor e\room\NPC[9] <> Null Lor e\room\NPC[10] <> Null
								...
								If e\EventStr <> "" And e\EventStr <> "Done"
									...
									If (Not ChannelPlaying(e\SoundCHN))
										...
										If e\EventStr = ""
											...
											e\room\NPC[4]\SoundCHN = PlaySound2(e\room\NPC[4]\Sound, Camera, e\room\NPC[4]\Collider, 10.0, 1.0, True)
								...
								Else
									...
									If e\room\NPC[3]\State3 >= 70.0 * 8.0 And e\room\NPC[3]\State3 - fps\Factor[0] < 70.0 * 8.0 And e\room\NPC[3]\State = 7.0
								...
								If e\room\NPC[3]\State <> 11.0
									...
									Else
										...
										If Dist > 30.25
											...
											If e\room\NPC[3]\State2 = 0.0
												...
												e\room\NPC[3]\SoundCHN = PlaySound2(e\room\NPC[3]\Sound, Camera, e\room\NPC[3]\Collider, 10.0, 1.0, True)
												;PlaySound2(e\Sound, Camera, e\room\NPC[3]\Collider) ;<---- What's that?
									...
									If Dist > 2.25 And EntityDistanceSquared(e\room\NPC[3]\Collider, me\Collider) < EntityDistanceSquared(e\room\NPC[3]\Collider, e\room\NPC[4]\Collider)
								...
								If DistanceSquared(EntityX(e\room\NPC[3]\Collider), EntityX(e\room\RoomDoors[2]\FrameOBJ, True), EntityZ(e\room\NPC[3]\Collider), EntityZ(e\room\RoomDoors[2]\FrameOBJ, True)) < 20.25 And Dist < 25.0
							...
							ElseIf e\EventState3 <= 905.0
								...
								ElseIf e\room\NPC[3]\Frame >= 358.0
									...
									Else
										...
										If InteractObject(e\room\NPC[3]\OBJ, 2.25)
								...
								EndIf
							Else
								If e\room\NPC[3]\State3 = 0.0
									If e\room\NPC[3]\Frame <= 620.5 And e\room\NPC[3]\State = 8.0
								...
								Else
									If e\room\RoomDoors[2]\Open
										...
										If e\room\NPC[3]\State3 >= 70.0 * 8.0 And e\room\NPC[3]\State3 - (fps\Factor[0] / Temp) < 70.0 * 8.0 And e\room\NPC[3]\State = 9.0
											...
											EndIf
										EndIf
										If DistanceSquared(EntityX(me\Collider), e\room\x, EntityZ(me\Collider), e\room\z) < 16.0
											For i = 1 To 2
												OpenCloseDoor(e\room\RoomDoors[i])
											Next
											For i = 3 To 4
							...
							If e\room\NPC[7] <> Null
								...
								If e\room\NPC[6]\State = 1.0
									If e\room\NPC[7]\Sound <> 0 Then e\room\NPC[7]\SoundCHN = LoopSound2(e\room\NPC[7]\Sound, e\room\NPC[7]\SoundCHN, Camera, e\room\NPC[7]\Collider, 7.0, 1.0, True)
								EndIf
							EndIf
						Else
							If IntroSFX[4] <> 0 Then e\SoundCHN2 = LoopSound2(IntroSFX[4], e\SoundCHN2, Camera, e\room\Objects[4], 6.0)
							
							If e\EventState < 10000.0
								...
								ElseIf e\EventState > 230.0
									Temp = True
									For i = 1 To 2
										If DistanceSquared(EntityX(e\room\NPC[i]\Collider), EntityX(e\room\Objects[i + 2], True), EntityZ(e\room\NPC[i]\Collider), EntityZ(e\room\Objects[i + 2], True)) > 0.09
							...
							ElseIf e\EventState < 14000.0 ; ~ Player is inside the room
								...
								If e\EventState >= 10300.0 And e\EventState - fps\Factor[0] < 10300.0
								...
								If e\EventState >= 10440.0 And e\EventState - fps\Factor[0] < 11561.0
									If EntityX(me\Collider) < EntityX(e\room\RoomDoors[1]\FrameOBJ, True)
										If e\room\NPC[0]\State <> 12.0
											...
											e\room\NPC[0]\SoundCHN = PlaySound2(e\room\NPC[0]\Sound, Camera, e\room\NPC[0]\Collider, 20.0, 1.0, True)
								...
								If e\EventState > 10300.0
									If e\EventState > 10560.0
										If e\EventState < 10750.0
							...
							ElseIf e\EventState < 20000.0
								...
								If e\EventState < 14100.0
									If e\EventState < 14060.0
									...
									ElseIf e\EventState < 14065.0
										...
										e\EventState = 14065.0
									Else
										If e\room\NPC[2]\Sound = 0
											LoadNPCSound(e\room\NPC[2], "SFX\Room\Intro\ClassD\Gasp.ogg")
											PlaySound2(e\room\NPC[2]\Sound, Camera, e\room\NPC[2]\Collider, 8.0, 1.0, True)
										EndIf
									EndIf
								...
								Else
									If e\EventState > 14300.0
										If e\EventState > 14600.0 And e\EventState < 14700.0
											me\BlinkTimer = -10.0
											me\LightBlink = 1.0
										EndIf
							...
							ElseIf e\EventState < 30000.0
								...
								If e\EventState < 20100.0
									me\BigCameraShake = 2.0
								Else
									If e\EventState < 20200.0
										If e\EventState > 20105.0 And e\EventState - fps\Factor[0] < 20105.0
									...
									ElseIf e\EventState < 20300.0
										...
										UpdateSoundOrigin(e\room\NPC[0]\SoundCHN, Camera, e\room\NPC[0]\Collider, 20.0, 1.0, True)
										If e\EventState > 20260.0 And e\EventState - fps\Factor[0] < 20260.0 Then PlaySound_Strict(IntroSFX[Rand(8, 10)])
									Else
										If e\EventState - fps\Factor[0] < 20300.0
											me\BlinkTimer = -10.0
											me\LightBlink = 1.0
											me\BigCameraShake = 3.0
											PlaySound_Strict(IntroSFX[Rand(8, 10)])
					...
					Else
						If me\Terminated
							If e\room\NPC[3] <> Null
								If e\room\NPC[3]\State = 1.0 Lor e\room\NPC[3]\State = 11.0
			...
			Case e_cont1_005
				...
				If (Not n_I\Curr106\Contained)
					If I_005\ChanceToSpawn < 3
						If PlayerRoom = e\room
							If e\EventState = 0.0
								TFormPoint(0.0, 255.0, 238.0, e\room\OBJ, 0)
								it.Items = CreateItem("SCP-005", "scp005", 0.0, TFormedY(), TFormedZ())
								EntityType(it\Collider, HIT_ITEM)
								
								TFormPoint(-362.0, 0.0, -420.0, e\room\OBJ, 0)
								de.Decals = CreateDecal(DECAL_CORROSIVE_1, TFormedX(), 0.005, TFormedZ(), 90.0, Rnd(360.0), 0.0)
							...
							ElseIf e\EventState = 1.0
								If Pvt = 0
									...
									Pvt = CreatePivot()
									PositionEntity(Pvt, 0.0, 0.0, TFormedZ(), True)
								EndIf
								If (Not (chs\NoTarget Lor I_268\InvisibilityOn))
									If EntityDistanceSquared(me\Collider, Pvt) < 1.69
					...
					Else
						If e\room\Dist < 8.0
							If I_005\ChanceToSpawn >= 5
								...
								de.Decals = CreateDecal(DECAL_BLOOD_2, x, y + (99.0 * RoomScale), z, 0.0, e\room\Angle + 270.0, 0.0, 0.3)
								EntityParent(de\OBJ, e\room\OBJ)
								
								TFormPoint(0.0, 255.0, 238.0, e\room\OBJ, 0)
								it.Items = CreateItem("Note from Maynard", "paper", 0.0, TFormedY(), TFormedZ())
								EntityType(it\Collider, HIT_ITEM)
							EndIf
							RemoveEvent(e)
						EndIf
				...
				If PlayerRoom = e\room
					If EntityY(me\Collider) < (-9500.0) * RoomScale
						If e\EventState = 0.0
							...
							it.Items = CreateItem("Document SCP-079", "paper", TFormedX(), TFormedY(), TFormedZ())
							EntityType(it\Collider, HIT_ITEM)
							
							e\EventState = 1.0
						EndIf
						If e\room\Objects[0] = 0
							TFormPoint(166.0, -10800.0, 1606.0, e\room\OBJ, 0)
							e\room\Objects[0] = LoadAnimMesh_Strict("GFX\Map\Props\079.b3d")
							PositionEntity(e\room\Objects[0], TFormedX(), TFormedY(), TFormedZ(), True)
							ScaleEntity(e\room\Objects[0], 1.3, 1.3, 1.3)
							RotateEntity(e\room\Objects[0], 0.0, e\room\Angle - 90.0, 0.0, True)
							EntityParent(e\room\Objects[0], e\room\OBJ)
							
							e\room\Objects[1] = CreateSprite(e\room\Objects[0])
							e\room\ScriptedObject[1] = True
							SpriteViewMode(e\room\Objects[1], 2)
							PositionEntity(e\room\Objects[1], 0.082, 0.119, 0.010)
							ScaleSprite(e\room\Objects[1], 0.09, 0.0725)
							TurnEntity(e\room\Objects[1], 0.0, 13.0, 0.0)
							MoveEntity(e\room\Objects[1], 0.0, 0.0, -0.022)
							...
							If e\EventState = 0.0
								...
								If SoundTransmission
									...
									If d_I\ClosestButton = e\room\Objects[0] And mo\MouseHit1
										...
										e\SoundCHN = PlaySound_Strict(FemurBreakerSFX, True)
				...
				If PlayerRoom = e\room
					...
					If CoffinDistance < 2.0
						...
						If e\room\NPC[0] = Null
							...
							e\room\NPC[0]\SoundCHN = PlaySound2(e\room\NPC[0]\Sound, Camera, e\room\NPC[0]\Collider, 10.0, 1.0, True)
					...
					ElseIf CoffinDistance > 6.0
						If e\room\NPC[0] <> Null
							If e\room\NPC[0]\PrevState = 0
								...
								e\room\NPC[0]\SoundCHN = PlaySound2(e\room\NPC[0]\Sound, Camera, e\room\NPC[0]\Collider, 100.0, 1.0, True)
						...
						For i = 0 To MaxItemAmount - 1
							If Inventory(i) <> Null
								If (wi\NightVision > 0 And (Inventory(i)\ItemTemplate\TempName = "nvg" Lor Inventory(i)\ItemTemplate\TempName = "veryfinenvg" Lor Inventory(i)\ItemTemplate\TempName = "finenvg")) Lor ((wi\SCRAMBLE = 1 And Inventory(i)\ItemTemplate\TempName = "scramble") Lor (wi\SCRAMBLE = 2 And Inventory(i)\ItemTemplate\TempName = "finescramble"))
									If Inventory(i)\State > 0.0 Lor (wi\NightVision = 3 And Inventory(i)\ItemTemplate\TempName = "finenvg")
				...
				If PlayerRoom = e\room
							...
							ElseIf GrabbedEntity = e\room\Objects[1]
								If e\EventState = 0.0
									...
									If (Rotation > -94.0 And Rotation < -86.0) Lor (Rotation > -44.0 And Rotation < -36.0) Lor (Rotation > -4.0 And Rotation < 4.0) Lor (Rotation > 36.0 And Rotation < 44.0) Lor (Rotation > 86.0 And Rotation < 94.0)
										If e\SoundCHN = 0 Then e\SoundCHN = PlaySound2(KnobSFX[Rand(0, 1)], Camera, e\room\Objects[1], 2.0, 0.5)
									Else
										e\SoundCHN = 0
									EndIf
								EndIf
					...
					If GrabbedEntity <> e\room\Objects[1]
						...
						If Angle = -90.0 Lor Angle = -40.0 Lor Angle = -1.0 Lor Angle = 0.0 Lor Angle = 40.0 Lor Angle = 90.0
							If e\SoundCHN2 = 0 Then e\SoundCHN2 = PlaySound2(KnobSFX[Rand(0, 1)], Camera, e\room\Objects[1], 2.0, 0.5)
						EndIf
					EndIf
					...
					If e\EventState > 0.0
						...
						CanSave = 0
						If (Not n_I\Curr106\Contained)
							If n_I\Curr106\State > 0.0 Then n_I\Curr106\State = n_I\Curr106\State - (fps\Factor[0] * (1.6 + (SelectedDifficulty\AggressiveNPCs)))
						EndIf
									...
									If EntityVisible(e\room\Objects[0], Camera)
										...
										If Dist < 0.36
											...
											ElseIf e\EventState2 > 70.0 * 74.0 And e\EventState2 - fps\Factor[0] <= 70.0 * 74.0
												...
												InjurePlayer(0.8)
												PlaySound_Strict(LoadTempSound("SFX\SCP\012\Speech7.ogg"), True)
							...
							If Temp And x
								...
								If e\room\NPC[0]\Idle > 0
									...
									If i > 0
										...
										e\room\NPC[0]\SoundCHN2 = LoopSound2(e\room\NPC[0]\Sound2, e\room\NPC[0]\SoundCHN2, Camera, e\room\NPC[0]\OBJ, 10.0, 1.0, True)
					...
					If EntityY(me\Collider) < (-3728.0) * RoomScale
						...
						If e\EventState = 0.0
							If Temp
								...
								it.Items = CreateItem("SCP-005", "scp005", TFormedX(), TFormedY(), TFormedZ())
								EntityType(it\Collider, HIT_ITEM)
							EndIf
							...
							it.Items = CreateItem("Document SCP-409", "paper", TFormedX(), TFormedY(), TFormedZ())
			...
			Case e_cont2_1123
				;[Block]
				If PlayerRoom = e\room
					If I_714\Using = 0 And wi\HazmatSuit <> 4 And wi\GasMask <> 4
					...
					ElseIf e\EventState = 2.0
						...
						If e\EventState2 > 1000.0
							...
							If e\EventState2 >= 1040.0 And e\EventState2 - fps\Factor[0] < 1040.0 
								PlaySound2(LoadTempSound("SFX\SCP\1123\Officer1.ogg"), Camera, e\room\NPC[0]\OBJ, 10.0, 1.0, True)
							ElseIf e\EventState2 >= 1400.0 And e\EventState2 - fps\Factor[0] < 1400.0
								PlaySound2(LoadTempSound("SFX\SCP\1123\Officer2.ogg"), Camera, e\room\NPC[0]\OBJ, 10.0, 1.0, True)
							EndIf
					...
					ElseIf e\EventState = 5.0
						...
						If e\EventState2 > 500.0
							...
							e\room\NPC[0]\SoundCHN = PlaySound2(e\room\NPC[0]\Sound, Camera, e\room\NPC[0]\Collider, 7.0, 1.0, True)
				...
				Else
					...
					ElseIf e\EventState < 70.0 * 6.5
						If e\EventState - fps\Factor[0] < 70.0 * 3.0
							...
							e\room\NPC[1]\SoundCHN = PlaySound2(e\room\NPC[1]\Sound, Camera, e\room\NPC[1]\Collider, 12.0, 1.0, True)
						EndIf
					...
					If InteractObject(e\room\Objects[0], 2.25)
						...
						If e\EventState2 < 2.0
							If SelectedItem <> Null
								If SelectedItem\ItemTemplate\TempName = "25ct" Lor SelectedItem\ItemTemplate\TempName = "coin"
			...
			Case e_room2c_gw_lcz_173
				...
				If e\room\Dist < 6.0 And e\room\Dist > 0.0
					If n_I\Curr173\Idle > 1
						RemoveEvent(e)
					Else
						If (Not EntityInView(n_I\Curr173\Collider, Camera)) Lor EntityDistanceSquared(n_I\Curr173\Collider, me\Collider) > 225.0 
			...
			Case e_room2_6_lcz_173
				;[Block]
				If PlayerRoom = e\room
					If n_I\Curr173\Idle = 0 And EntityDistanceSquared(me\Collider, e\room\Objects[0]) > 21.0
			...
			Case e_room2_ic
				...
				If PlayerRoom = e\room
					...
					de.Decals = CreateDecal(DECAL_BLOOD_2, x, y + 0.005, 0.0, 90.0, Rnd(360.0), 0.0)
					EntityParent(de\OBJ, e\room\OBJ)
					
					e\room\NPC[0] = CreateNPC(NPCTypeD, x, y, 0.0)
					e\room\NPC[0]\State3 = -1.0 : e\room\NPC[0]\IsDead = True
					...
					If PlayerRoom = e\room
						...
						If e\room\NPC[0] = Null And Temp
							...
							Else
								...
								EndIf
							EndIf
							e\room\NPC[0] = CreateNPC(NPCTypeClerk, EntityX(e\room\OBJ, True) + x * RoomScale, 0.4, EntityZ(e\room\OBJ, True) + z * RoomScale)
							e\room\NPC[0]\State = 2.0
							PointEntity(e\room\NPC[0]\Collider, e\room\OBJ)
							e\EventState = 0.0
						EndIf
					...
					Select e\EventState
						...
						Case 1.0 ; ~ Charge state
							...
							If e\EventState2 >= 35.0
								PlaySound2(LoadTempSound("SFX\Room\Tesla\Shock.ogg"), Camera, e\room\Objects[0])
								e\EventState = 2.0
							EndIf
							;[End Block]
						Case 2.0 ; ~ Zap state
							...
							If e\EventState2 <= 0.0
								StopChannel(e\SoundCHN) : e\SoundCHN = 0
								e\SoundCHN = PlaySound2(TeslaPowerUpSFX, Camera, e\room\Objects[0], 4.0, 0.5)
								e\EventState = 3.0
								e\EventState2 = -70.0
							EndIf
							;[End Block]
			...
			Case e_room2_4_hcz
				...
				If n_I\Curr173\Idle = 0
					If e\room\Dist < 8.0 And e\room\Dist > 0.0
						If (Not EntityVisible(n_I\Curr173\Collider, Camera)) And (Not EntityVisible(e\room\Objects[0], Camera))
							PositionEntity(n_I\Curr173\Collider, EntityX(e\room\Objects[0], True), 0.5, EntityZ(e\room\Objects[0], True))
							ResetEntity(n_I\Curr173\Collider)
							RemoveEvent(e)
						EndIf
					...
					Else
						If (Not EntityInView(e\room\Objects[0], Camera))
							...
							If Rand(200) = 1 And e\EventState > 300.0
								e\SoundCHN = PlaySound2(e\Sound, Camera, e\room\Objects[0], 6.0)
								e\EventState = 0.0
							EndIf
						Else
							If ChannelPlaying(e\SoundCHN) Then StopChannel(e\SoundCHN) : e\SoundCHN = 0
				...
				If PlayerRoom = e\room
					...
					Else
						If EntityDistanceSquared(e\room\Objects[0], me\Collider) < 4.0
							...
							e\SoundCHN = LoopSound2(OldManSFX[4], e\SoundCHN, Camera, e\room\OBJ, 5.0, 0.3, True)
							If (Not n_I\Curr106\Contained)
					...
					If Temp
						...
						Select e\EventState
							...
							Case 14.0
								...
								For i = 0 To MaxItemAmount - 1
									If Inventory(i) <> Null
										If Inventory(i)\ItemTemplate\TempName = "paper"
											RemoveItem(Inventory(i))
											For itt.ItemTemplates = Each ItemTemplates
												If itt\TempName = "paper" And Rand(6) = 1
							...
							Case 40.0
								;[Block]
								PlaySound_Strict(LoadTempSound("SFX\Radio\Franklin4.ogg"), True)
								;[End Block]
							Case 50.0
								;[Block]
			...
			Case e_room3_2_ez_duck
				...
				If PlayerRoom = e\room
					If e\room\Objects[3] = 0
						...
						PositionEntity(e\room\Objects[3], TFormedX(), TFormedY(), TFormedZ(), True)
			...
			Case e_room3_2_hcz
				...
				If e\room\Dist < 8.0
					If e\EventState = 0.0
						...
						e\room\NPC[0]\State = 8.0 : e\room\NPC[0]\IsDead = True
						SetNPCFrame(e\room\NPC[0], 288.0)
						RotateEntity(e\room\NPC[0]\Collider, 0.0, e\room\Angle + Rnd(160.0, 180.0), 0.0, True)
			...
			Case e_682_roar
				;[Block]
				If e\EventState = 0.0
					If PlayerRoom = e\room e\EventState = 70.0 * Rnd(50.0, 100.0)
			...
			Case e_1048_a
				...
				If e\room\Objects[0] = 0
					If PlayerRoom <> e\room
						If DistanceSquared(EntityX(me\Collider), EntityX(e\room\OBJ), EntityZ(me\Collider), EntityZ(e\room\OBJ)) < 256.0
			...
			Case e_room4_2_hcz
				...
				If e\room\Dist < 8.0
					...
					SetNPCFrame(e\room\NPC[0], 19.0)
					RotateEntity(e\room\NPC[0]\Collider, 0.0, e\room\Angle - 30.0, 0.0, True)
					RemoveEvent(e)
				EndIf
				;[End Block]
			Case e_room2_gw_2
							...
							If e\room\NPC[0]\PathTimer = 0.0
								If e\room\NPC[0]\PrevState = 1
									If e\room\NPC[0]\SoundCHN2 = 0
										...
										e\room\NPC[0]\SoundCHN2 = PlaySound2(e\room\NPC[0]\Sound2, Camera, e\room\NPC[0]\Collider, 10.0, 1.0, True)
									Else
			...
			Case e_room2_medibay
				...
				If PlayerRoom = e\room
					...
					If e\room\Objects[1] = 0
						...
						PositionEntity(e\room\Objects[1], TFormedX(), TFormedY(), TFormedZ(), True)
						RotateEntity(e\room\Objects[1], 6.0, e\room\Angle + 180.0, 0.0, True)
			...
			Case e_room2_shaft
				...
				If PlayerRoom = e\room
					...
					If d_I\ClosestButton = e\room\Objects[1] And mo\MouseHit1
						...
						PlaySound2(ButtonSFX2, Camera, e\room\Objects[1])
						mo\MouseHit1 = False
					EndIf
				EndIf
				;[End Block]
									...
									If Dist < 225.0
										...
										If Dist < 0.16
											...
											If n_I\Curr106\State3 = 0.0
												...
												e\SoundCHN = PlaySound2(e\Sound, Camera, n_I\Curr106\Collider, 35.0, 1.0, True)
											EndIf
...
Function Update096ElevatorEvent#(e.Events, EventState#, d.Doors, ElevatorOBJ%)
	...
	If d\OpenState = 0.0 And (Not d\Open)
		If IsInsideElevator(me\Collider, ElevatorOBJ)
			If EventState = 0.0
