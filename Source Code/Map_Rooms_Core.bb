...
Function FillRoom%(r.Rooms)
	...
	Select r\RoomTemplate\RoomID
		...
		Case r_cont1_173_intro
			...
			d.Doors = CreateDoor(r, r\x - 8416.0 * RoomScale, r\y, r\z - 1248.0 * RoomScale, 270.0, False)
			d\Locked = 1 : d\DisableWaypoint = True : d\MTFClose = False
			FreeEntity(d\Buttons[0]) : d\Buttons[0] = 0
			FreeEntity(d\OBJ2) : d\OBJ2 = 0
		...
		Case r_room2_tesla_lcz, r_room2_tesla_hcz, r_room2_tesla_2_hcz, r_room2_tesla_ez
			...
			For r2.Rooms = Each Rooms
				...
				EndIf
			Next
			If r\Objects[2] = 0 Then r\Objects[2] = LoadRMesh(RoomPartsPath + "room2_tesla_blinds.rmesh", Null, False)
			ScaleEntity(r\Objects[2], RoomScale, RoomScale, RoomScale)
			EntityParent(r\Objects[2], r\OBJ)
			HideEntity(r\Objects[2])
		...
		Case r_cont2_012
			...
			r\Objects[2] = LoadRMesh(RoomPartsPath + "ventilation_fan.rmesh", Null, False)
			ScaleEntity(r\Objects[2], RoomScale, RoomScale, RoomScale)
		...
		Case r_cont3_966
			...
			it.Items = CreateItem("Document SCP-966", it_paper, r\x + 128.0 * RoomScale, r\y + 0.5, r\z - 335.0 * RoomScale)
			EntityParent(it\Collider, r\OBJ)
		...
		Case r_room2_ic
			...
			; ~ Elevators' pivots
			r\Objects[0] = CreatePivot()
			PositionEntity(r\Objects[0], r\x - 1200.0 * RoomScale, r\y + ElevatorPivotShift, r\z)
			EntityParent(r\Objects[0], r\OBJ)
			
			r\Objects[1] = CreatePivot()
			PositionEntity(r\Objects[1], r\x - 1200.0 * RoomScale, r\y + 4632.0 * RoomScale + ElevatorPivotShift, r\z)
			EntityParent(r\Objects[1], r\OBJ)
		...
		Case r_room3_gw
			...
			d.Doors = CreateDoor(r, r\x + 248.0 * RoomScale, r\y, r\z - 736.0 * RoomScale, 90.0, False, DEFAULT_DOOR, KEY_CARD_1)
			d\Locked = 1 : d\DisableWaypoint = True : d\MTFClose = False
			FreeEntity(d\Buttons[0]) : d\Buttons[0] = 0
			FreeEntity(d\OBJ2) : d\OBJ2 = 0
