...
Function SaveGame%(File$)
	...
	If me\DropSpeed > 0.02 * fps\Factor[1] Lor me\DropSpeed < (-0.02) * fps\Factor[1] Then Return
...
Function LoadGame%(File$)
	...
	y = ReadFloat(f)
	z = ReadFloat(f)
	PositionEntity(me\Collider, x, y + 0.15, z)
	...
	y = ReadFloat(f)
	z = ReadFloat(f)
	PositionEntity(me\Head, x, y + 0.15, z)
	ResetEntity(me\Head)
