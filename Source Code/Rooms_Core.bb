Function FillRoom%(r.Rooms)
	...
	Select r\RoomTemplate\RoomID
		...
		Case r_cont1_205
			...
			it.Items = CreateItem("Document SCP-205", it_paper, r\x - 357.0 * RoomScale, r\y + 100.0 * RoomScale, r\z + 150.0 * RoomScale)
			EntityParent(it\Collider, r\OBJ)
			
			it.Items = CreateItem("Ballistic Helmet", it_helmet, r\x + 206.0 * RoomScale, r\y + 230.0 * RoomScale, r\z - 80.0 * RoomScale)
			EntityParent(it\Collider, r\OBJ)
		...
		Case r_room2_gw, r_room2_gw_2
			...
			If r\RoomTemplate\RoomID = r_room2_gw_2
				...
				dem.DevilEmitters = CreateDevilEmitter(r\x + 262.0 * RoomScale, r\y + 325.0 * RoomScale, r\z - 345.0 * RoomScale, r, 1, 2.0)
			Else
				r\Objects[0] = CreatePivot()
		...
		Case r_room2c_gw_lcz
			...
			; ~ Smoke
			dem.DevilEmitters = CreateDevilEmitter(r\x - 175.0 * RoomScale, r\y + 330.0 * RoomScale, r\z + 655.0 * RoomScale, r, PARTICLE_BLACK_SMOKE, 2.0)
			dem\IsBlackSmoke = True
			
			dem.DevilEmitters = CreateDevilEmitter(r\x - 655.0 * RoomScale, r\y + 330.0 * RoomScale, r\z + 240.0 * RoomScale, r, PARTICLE_BLACK_SMOKE, 2.0)
			dem\IsBlackSmoke = True
		...
		Case r_room3_storage
			...
			it.Items = CreateItem("Level 1 Key Card", it_key1, r\x + 3370.0 * RoomScale, r\y - 5496.0 * RoomScale, r\z + 6201.0 * RoomScale)
			EntityParent(it\Collider, r\OBJ)
