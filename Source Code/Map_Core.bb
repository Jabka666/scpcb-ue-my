...
Function UpdateSecurityCams%()
	...
	For sc.SecurityCams = Each SecurityCams
		...
		Else
			If sc\room\Dist < 6.0 Lor PlayerRoom = sc\room
				Close = True
			ElseIf sc\Cam <> 0
				If (Not EntityHidden(sc\Cam)) Then HideEntity(sc\Cam)
			EndIf
			...
			If Close
				If sc\Screen
					...
					If PlayerRoom\RoomTemplate\Name <> "cont1_173_intro"
						If sc\InSight And sc\CoffinEffect = 0 Lor sc\CoffinEffect = 2
...
Function FillRoom%(r.Rooms)
	...
	Select r\RoomTemplate\Name
		...
		Case "room2_gw", "room2_gw_2"
			...
			If r\RoomTemplate\Name = "room2_gw"
				r\Objects[0] = CreatePivot()
		...
		Case "cont2_409"
			...
			If I_005\ChanceToSpawn > 2 And I_005\ChanceToSpawn < 5
				...
				; ~ Class-D spawn
				r\Objects[4] = CreatePivot()
				PositionEntity(r\Objects[4], r\x - 4812.0 * RoomScale, r\y - 4491.0 * RoomScale, r\z + 1729.0 * RoomScale)
				EntityParent(r\Objects[4], r\OBJ)
		...
		Case "cont3_966"
			...
			r\RoomDoors.Doors[1] = CreateDoor(r\x, r\y, r\z - 480.0 * RoomScale, 0.0, r, False, DEFAULT_DOOR, KEY_CARD_3)
		...
		Case "gate_a_entrance"
			...
			r\RoomDoors[1]\DisableWaypoint = True : r\RoomDoors[1]\MTFClose = False
