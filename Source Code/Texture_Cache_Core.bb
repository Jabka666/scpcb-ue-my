...
Function LoadCubeTexture%(Tex$, Flags%)
	...
	If TextureHeight(CubeMap) >= Width / 4 ; ~ Base cubemap
		...
		CopyRectStretch(Width * 1, Width, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		SetCubeFace(CubeTexture, 2)
		CopyRectStretch(Width * 2, Width, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		SetCubeFace(CubeTexture, 3)
		CopyRectStretch(Width * 3, Width, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		SetCubeFace(CubeTexture, 4)
		CopyRectStretch(Width * 1, Width * 0, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
	...
	ElseIf TextureHeight(CubeMap) = Width / 6 ; ~ Cubemap in line
		...
		SetCubeFace(CubeTexture, 3)
		CopyRectStretch(Width * 1, 0, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		SetCubeFace(CubeTexture, 2)
		CopyRectStretch(Width * 2, 0, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		SetCubeFace(CubeTexture, 1)
		CopyRectStretch(Width * 3, 0, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		SetCubeFace(CubeTexture, 4)
		CopyRectStretch(Width * 4, 0, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		SetCubeFace(CubeTexture, 5)
		CopyRectStretch(Width * 5, 0, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
	Else ; ~ 2D Texture, just copy same to all faces
		CubeTexture = CreateTexture(Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, Flags Or 8)
		For i = 0 To 5
			SetCubeFace(CubeTexture, i)
			CopyRectStretch(0, 0, Width, Width, 0, 0, Width / opt\TextureQualityLevel, Width / opt\TextureQualityLevel, TextureBuffer(CubeMap), TextureBuffer(CubeTexture))
		Next
	EndIf
