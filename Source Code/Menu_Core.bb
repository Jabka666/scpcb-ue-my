				...
				Case MainMenuTab_Load_Game
					...
					If SaveGameAmount <> 0 Then
						...
						If DelSave <> Null Then
							...
							If UpdateMainMenuButton(x + (50 * MenuScale), y + (150 * MenuScale), 100 * MenuScale, 30 * MenuScale, GetLocalString("menu", "yes"), False) Then
								DeleteGame(DelSave)
								mm\ShouldDeleteGadgets = True
							EndIf
							If UpdateMainMenuButton(x + (250 * MenuScale), y + (150 * MenuScale), 100 * MenuScale, 30 * MenuScale, GetLocalString("menu", "no"), False) Then
								DelSave = Null
								mm\ShouldDeleteGadgets = True
							EndIf
						EndIf
				...
				Case MainMenuTab_Options_Graphics, MainMenuTab_Options_Audio, MainMenuTab_Options_Controls, MainMenuTab_Options_Advanced
					...
					Select mm\MainMenuTab
						Case MainMenuTab_Options_Graphics
							...
							opt\Anisotropic = UpdateMainMenuSlider5(x, y, 150 * MenuScale, opt\Anisotropic, 4, GetLocalString("options", "tri"), "2x", "4x", "8x", "16x")
						...
						Case MainMenuTab_Options_Audio
							...
							If opt\EnableUserTracks Then
								...
								If UpdateMainMenuButton(x - (290 * MenuScale), y + (30 * MenuScale), 210 * MenuScale, 30 * MenuScale, GetLocalString("options", "scantracks"), False)
									UserTrackCheck = 0
									UserTrackCheck2 = 0
					...
					Case MainMenuTab_Options_Advanced
						...
						If mm\CurrMenuPage = 0 Then
							...
							If opt\CurrFrameLimit > 0.0 Then
								Color(255, 255, 0)
								Text(x, y + (45 * MenuScale), Format(GetLocalString("options", "frame.fps"), opt\FrameLimit))
