								...
								Else
									...
									If me\CurrSpeed > 0.03 ; ~ The player is running
										...
										If Rnd(5000.0) < n\State3
											...
											If Temp Then n\SoundCHN = PlaySoundEx(LoadTempSound("SFX\SCP\860_2\Cancer" + Rand(0, 2) + ".ogg"), Camera, n\Collider, 10.0, 1.0, True)
										EndIf
									Else
								...
								If NPCSeesPlayer(n, 4.0 - me\CrouchState + me\SndVolume) = 1
									...
									If n\State3 < 350.0
										...
										If I_714\Using <> 2 And wi\GasMask <> 4 And wi\HazmatSuit <> 4
											...
											Temp = (2100.0 + (700.0 * SelectedDifficulty\OtherFactors)) / (1.0 + I_714\Using)
											I_966\InsomniaEffectTimer = Max(I_966\InsomniaEffectTimer, Temp)
											I_966\InsomniaEffectTimer = Min(I_966\InsomniaEffectTimer + (fps\Factor[0] * (6.0 - (2.5 * I_714\Using))), Temp * 2.0)
										EndIf
									EndIf
									n\Angle = CurveAngle(EntityYaw(n\Collider, True), n\Angle, 20.0)
								EndIf
