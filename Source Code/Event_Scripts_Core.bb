...
Function UpdateEvent_Room2_Closets%(e.Events)
	...
	If e\EventState = 0.0
		...
		EndIf
	Else
		UpdateSoundOrigin(e\room\NPC[0]\SoundCHN, Camera, e\room\NPC[0]\Collider, 10.0, 1.0, True)
		UpdateSoundOrigin(e\room\NPC[1]\SoundCHN, Camera, e\room\NPC[1]\Collider, 10.0, 1.0, True)
