...
Function DrawEnding()
	...
	Select Lower(SelectedEnding)
		Case "b2", "a1"
			;[Block]
			ClsColor(Max(255 + (EndingTimer) * 2.8, 0.0), Max(255 + (EndingTimer) * 2.8, 0.0), Max(255 + (EndingTimer) * 2.8, 0.0))
			;[End Block]
		Default
			;[Block]
			ClsColor(0, 0, 0)
					...
					Select Setting
						...
						Case "1:1"
							...
							Select Rand(20)
								...
								Case 8
									;[Block]
									it2 = CreateItem("Document SCP-372", "paper", x, y, z) ; ~ TEST FOR THE ACCESS CODE! - Jabka
									;[End Block]
								Case 9
									;[Block]
