...
Function LoadItems%()
	...
	;CreateItemTemplate(GetLocalString("items", "docgears"), "Note from Gears", it_paper, "note.b3d", "INV_note.png", "note_Gears.png", 0.0025, 0, "note_Gears.png")
	...
	;[Block]
	CreateItemTemplate(GetLocalString("items", "key0"), "Level 0 Key Card", it_key0, "key_card.b3d", "INV_key_card_lvl_0.png", "", 0.00037, 1, "", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key0"), "Bloody Level 0 Key Card", it_key0, "key_card.b3d", "INV_key_card_lvl_0_bloody.png", "", 0.00037, 1, "key_card_lvl_0_bloody.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key1"), "Level 1 key Card", it_key1, "key_card.b3d", "INV_key_card_lvl_1.png", "", 0.00037, 1, "key_card_lvl_1.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key1"), "Bloody Level 1 key Card", it_key1, "key_card.b3d", "INV_key_card_lvl_1_bloody.png", "", 0.00037, 1, "key_card_lvl_1_bloody.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key2"), "Level 2 key Card", it_key2, "key_card.b3d", "INV_key_card_lvl_2.png", "", 0.00037, 1, "key_card_lvl_2.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key3"), "Level 3 key Card", it_key3, "key_card.b3d", "INV_key_card_lvl_3.png", "", 0.00037, 1, "key_card_lvl_3.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key3"), "Bloody Level 3 key Card", it_key3, "key_card.b3d", "INV_key_card_lvl_3_bloody.png", "", 0.00037, 1, "key_card_lvl_3_bloody.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key4"), "Level 4 key Card", it_key4, "key_card.b3d", "INV_key_card_lvl_4.png", "", 0.00037, 1, "key_card_lvl_4.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key5"), "Level 5 key Card", it_key5, "key_card.b3d", "INV_key_card_lvl_5.png", "", 0.00037, 1, "key_card_lvl_5.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "key6"), "Level 6 Key Card", it_key6, "key_card.b3d", "INV_key_card_lvl_6.png", "", 0.00037, 1, "key_card_lvl_6.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "keyomni"), "Key Card Omni", it_keyomni, "key_card.b3d", "INV_key_card_lvl_omni.png", "", 0.00037, 1, "key_card_lvl_omni.png", "", False, 1, True, 0.45)

	CreateItemTemplate(GetLocalString("items", "mastercard"), "Mastercard", it_mastercard, "key_card.b3d", "INV_master_card.png", "", 0.00037, 1, "master_card.png", "", False, 1, True, 0.45)
	CreateItemTemplate(GetLocalString("items", "mastercard"), "Mastercard", it_mastercard_golden, "key_card.b3d", "INV_master_card_golden.png", "", 0.00037, 1, "master_card_golden.png", "", False, 1, True, 0.45)
