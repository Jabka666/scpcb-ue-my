...
Function InitNewGame%()
	...
	Next
	If CODE_DR_MAYNARD = CODE_DR_HARP Lor CODE_DR_MAYNARD = CODE_CONT1_035 Then CODE_DR_MAYNARD = CODE_DR_MAYNARD + 1
	...
	CODE_DR_GEARS = ((Int(CODE_DR_MAYNARD) * 4) Mod 10000)
