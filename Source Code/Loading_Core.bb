...
Const NPC_CLASS_D_FRANKLIN_TEXTURE% = 5
Const NPC_CLASS_D_MAYNARD_TEXTURE% = 6
Const NPC_CLASS_D_CLASS_D_TEXTURE% = 7
Const NPC_CLASS_D_D9341_TEXTURE% = 8
Const NPC_CLASS_D_JANITOR_TEXTURE% = 9
Const NPC_CLASS_D_MAINTENANCE_TEXTURE% = 10
Const NPC_CLASS_D_LOGISTICS_TEXTURE% = 11
Const NPC_CLASS_D_HARN_TEXTURE% = 12
Const NPC_CLASS_D_RUFINO_TEXTURE% = 13

Const NPC_MTF_LEADER_TEXTURE% = 14

Const NPC_096_BLOODY_TEXTURE% = 15
Const NPC_008_1_TEXTURE% = 16
Const NPC_008_1_TEXTURE_2% = 17

Const NPC_CLASS_D_BODY_1_TEXTURE% = 18
Const NPC_CLASS_D_BODY_2_TEXTURE% = 19
Const NPC_CLASS_D_VICTIM_009_TEXTURE% = 20
Const NPC_CLASS_D_VICTIM_035_TEXTURE% = 21
Const NPC_CLASS_D_VICTIM_035_CORPSE_TEXTURE% = 22
Const NPC_CLASS_D_VICTIM_106_TEXTURE% = 23
Const NPC_CLASS_D_VICTIM_106_FEMUR_BREAKER_TEXTURE% = 24
Const NPC_CLASS_D_VICTIM_409_TEXTURE% = 25
Const NPC_CLASS_D_VICTIM_457_TEXTURE% = 26
Const NPC_CLASS_D_VICTIM_895_TEXTURE% = 27
Const NPC_CLASS_D_VICTIM_939_1_TEXTURE% = 28
Const NPC_CLASS_D_VICTIM_939_2_TEXTURE% = 29
Const NPC_CLASS_D_VICTIM_FEMUR_BREAKER_TEXTURE% = 30

Const NPC_CLERK_VICTIM_205_TEXTURE% = 31

Const NPC_CLASS_D_VICTIM_1048_A_TEXTURE% = 32
;[End Block]
...
Function LoadEntities%()
	...
	t\OverlayTextureID[0] = LoadTexture_Strict("GFX\Overlays\vignette_overlay.png", 1, DeleteAllTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Overlays\gas_mask_overlay.png", 1, DeleteMapTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Overlays\hazmat_suit_overlay.png", 1, DeleteMapTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Overlays\scp_008_overlay.png", 1, DeleteMapTextures, False)
	...
	t\OverlayTextureID[1] = LoadTexture_Strict("GFX\Overlays\night_vision_goggles_overlay.png", 1, DeleteAllTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Overlays\scp_409_overlay.png", 1, DeleteMapTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Overlays\helmet_overlay.png", 1, DeleteMapTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Overlays\fog_gas_mask_overlay.png", 1, DeleteMapTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Map\Textures\scp_009.png", 1, DeleteMapTextures, False)
	...
	Tex = LoadTexture_Strict("GFX\Overlays\fire_overlay.png", 1, DeleteMapTextures, False)
