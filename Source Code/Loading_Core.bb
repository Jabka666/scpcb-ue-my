...
Function InitNewGame%()
	...
	Next
	If CODE_DR_MAYNARD = (CODE_DR_HARP Lor CODE_CONT1_035 Lor CODE_DR_L) Then CODE_DR_MAYNARD = CODE_DR_MAYNARD + 1
	
	CODE_CMR = 0
	For i = 0 To 3
		CODE_CMR = CODE_CMR + (Rand(9) * (10 ^ i))
	Next
	If CODE_CMR = (CODE_DR_HARP Lor CODE_CONT1_035 Lor CODE_DR_L Lor CODE_DR_MAYNARD) Then CODE_CMR = CODE_CMR + 1
	
	CODE_MAINTENANCE_TUNNELS = 0
	For i = 0 To 3
		CODE_MAINTENANCE_TUNNELS = CODE_MAINTENANCE_TUNNELS + (Rand(9) * (10 ^ i))
	Next
	If CODE_MAINTENANCE_TUNNELS = (CODE_DR_HARP Lor CODE_CONT1_035 Lor CODE_DR_L Lor CODE_DR_MAYNARD Lor CODE_CMR) Then CODE_MAINTENANCE_TUNNELS = CODE_MAINTENANCE_TUNNELS + 1
	
	CODE_DR_GEARS = 0
	For i = 0 To 3
		CODE_DR_GEARS = CODE_DR_GEARS + (Rand(9) * (10 ^ i))
	Next
	If CODE_DR_GEARS = (CODE_DR_HARP Lor CODE_CONT1_035 Lor CODE_DR_L Lor CODE_DR_MAYNARD Lor CODE_CMR Lor CODE_MAINTENANCE_TUNNELS) Then CODE_DR_GEARS = CODE_DR_GEARS + 1
