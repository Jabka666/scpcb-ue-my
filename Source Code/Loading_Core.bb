...
Function LoadParticles%()
	...
	SetTemplateParticlesPerInterval(ParticleEffect[31], 2)
	...
	SetTemplateParticlesPerInterval(ParticleEffect[36], 5)
	...
	SetTemplateParticleLifeTime(ParticleEffect[38], 50, 60)
	SetTemplateTexture(ParticleEffect[38], PARTICLE_FIRE)
	SetTemplateOffset(ParticleEffect[38], -0.04, 0.04, -0.04, 0.04, -0.04, 0.04)
	SetTemplateVelocity(ParticleEffect[38], -0.008, 0.008, -0.006, 0.021, -0.006, 0.006)
