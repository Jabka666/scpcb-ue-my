...
Function InitNewGame%()
	...
	CODE_DR_MAYNARD = Rand(1000, 9990)
	...
	CODE_CMR = Rand(1000, 9990)
	If CODE_CMR = CODE_DR_HARP Lor CODE_CMR = CODE_CONT1_035 Lor CODE_CMR = CODE_DR_L Lor CODE_CMR = CODE_DR_MAYNARD Then CODE_CMR = CODE_CMR + 1
	
	CODE_MAINTENANCE_TUNNELS = Rand(1000, 9990)
	If CODE_MAINTENANCE_TUNNELS = CODE_DR_HARP Lor CODE_MAINTENANCE_TUNNELS = CODE_CONT1_035 Lor CODE_MAINTENANCE_TUNNELS = CODE_DR_L Lor CODE_MAINTENANCE_TUNNELS = CODE_DR_MAYNARD Lor CODE_MAINTENANCE_TUNNELS = CODE_CMR Then CODE_MAINTENANCE_TUNNELS = CODE_MAINTENANCE_TUNNELS + 1
	
	CODE_DR_GEARS = Rand(1000, 9990)
	If CODE_DR_GEARS = CODE_DR_HARP Lor CODE_DR_GEARS = CODE_CONT1_035 Lor CODE_DR_GEARS = CODE_DR_L Lor CODE_DR_GEARS = CODE_DR_MAYNARD Lor CODE_DR_GEARS = CODE_CMR Lor CODE_DR_GEARS = CODE_MAINTENANCE_TUNNELS Then CODE_DR_GEARS = CODE_DR_GEARS + 1
