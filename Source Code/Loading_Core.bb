...
Const NPC_CLASS_D_HARN_TEXTURE% = 11
Const NPC_CLASS_D_RUFINO_TEXTURE% = 12

Const NPC_MTF_LEADER_TEXTURE% = 13

Const NPC_096_BLOODY_TEXTURE% = 14
Const NPC_008_1_TEXTURE% = 15
Const NPC_008_1_TEXTURE_2% = 16

Const NPC_CLASS_D_BODY_1_TEXTURE% = 17
Const NPC_CLASS_D_BODY_2_TEXTURE% = 18
Const NPC_CLASS_D_VICTIM_009_TEXTURE% = 19
Const NPC_CLASS_D_VICTIM_035_TEXTURE% = 20
Const NPC_CLASS_D_VICTIM_035_CORPSE_TEXTURE% = 21
Const NPC_CLASS_D_VICTIM_106_TEXTURE% = 22
Const NPC_CLASS_D_VICTIM_106_FEMUR_BREAKER_TEXTURE% = 23
Const NPC_CLASS_D_VICTIM_409_TEXTURE% = 24
Const NPC_CLASS_D_VICTIM_457_TEXTURE% = 25
Const NPC_CLASS_D_VICTIM_895_TEXTURE% = 26
Const NPC_CLASS_D_VICTIM_939_1_TEXTURE% = 27
Const NPC_CLASS_D_VICTIM_939_2_TEXTURE% = 28
Const NPC_CLASS_D_VICTIM_FEMUR_BREAKER_TEXTURE% = 29

Const NPC_CLERK_VICTIM_205_TEXTURE% = 30

Const NPC_CLASS_D_VICTIM_1048_A_TEXTURE% = 31
;[End Block]
...
Function LoadEntities%()
	...
	Tex = LoadTexture_Strict("GFX\Overlays\fire_overlay.png", 1, DeleteMapTextures) ; ~ SCP-457 burning player
