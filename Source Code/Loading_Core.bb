...
Function LoadDecals%()
	...
	If S2IMapContains(UnlockedAchievements, "keter") Then de_I\DecalTextureID[DECAL_KETER] = LoadTexture_Strict("GFX\Menu\Achievements\AchvKeter.png", 1, DeleteAllTextures)
	If S2IMapContains(UnlockedAchievements, "apollyon") Then de_I\DecalTextureID[DECAL_APOLLYON] = LoadTexture_Strict("GFX\Menu\Achievements\AchvApollyon.png", 1 + 2, DeleteAllTextures)
...
Enum DoorModelID
	...
	DOOR_WOODEN_MODEL
	DOOR_FENCE_MODEL
	DOOR_ONE_SIDED_MODEL
	DOOR_914_MODEL_1
	DOOR_914_MODEL_2
End Enum

Enum DoorFrameModelID
	DOOR_DEFAULT_FRAME_MODEL
	DOOR_BIG_FRAME_MODEL
	DOOR_OFFICE_FRAME_MODEL
	DOOR_WOODEN_FRAME_MODEL
End Enum

Enum ButtonModelID
	BUTTON_DEFAULT_MODEL
	BUTTON_KEYCARD_MODEL
	BUTTON_KEYPAD_MODEL
	BUTTON_SCANNER_MODEL
	BUTTON_ELEVATOR_MODEL
End Enum

Enum ButtonTextureID
	BUTTON_GREEN_TEXTURE
	BUTTON_YELLOW_TEXTURE
	BUTTON_RED_TEXTURE
	BUTTON_106_TEXTURE
End Enum
...
Enum MonitorOverlays
	MONITOR_DEFAULT_OVERLAY
	MONITOR_LOCKDOWN_1_OVERLAY
	MONITOR_LOCKDOWN_2_OVERLAY
	MONITOR_LOCKDOWN_3_OVERLAY
	MONITOR_LOCKDOWN_4_OVERLAY
	MONITOR_079_OVERLAY_1
	MONITOR_079_OVERLAY_2
	MONITOR_079_OVERLAY_3
	MONITOR_079_OVERLAY_4
	MONITOR_079_OVERLAY_5
	MONITOR_079_OVERLAY_6
	MONITOR_079_OVERLAY_7
	MONITOR_895_OVERLAY_1
	MONITOR_895_OVERLAY_2
	MONITOR_895_OVERLAY_3
	MONITOR_895_OVERLAY_4
	MONITOR_895_OVERLAY_5
	MONITOR_895_OVERLAY_6
	MONITOR_895_OVERLAY_7
...
Function LoadMonitors%()
	...
	mon_I\MonitorOverlayID[MONITOR_096_OVERLAY] = LoadTexture_Strict("GFX\Overlays\scp_096_overlay.png", 1, DeleteAllTextures)
...
Enum NPCModels
	NPC_008_1_MODEL
	NPC_008_1_SURGEON_MODEL
	NPC_035_TENTACLE_MODEL
	NPC_049_MODEL
	NPC_049_2_MODEL
	NPC_066_MODEL
	NPC_096_MODEL
	...
	NPC_173_HEAD_MODEL
	NPC_173_BOX_MODEL
	NPC_205_DEMON_1_MODEL
	NPC_205_DEMON_2_MODEL
	NPC_205_DEMON_3_MODEL
	NPC_205_WOMAN_MODEL
	NPC_372_MODEL
	NPC_513_1_MODEL
	NPC_860_2_MODEL
	...
	NPC_1499_1_MODEL
	NPC_APACHE_MODEL
	NPC_APACHE_ROTOR_1_MODEL
	NPC_APACHE_ROTOR_2_MODEL
	NPC_CLERK_MODEL
	NPC_CLASS_D_MODEL
	NPC_COCKROACH_MODEL
	NPC_DUCK_MODEL
...
Enum NPCTextures
	; ~ Class D
	NPC_CLASS_D_GONZALES_TEXTURE
	NPC_CLASS_D_BENJAMIN_TEXTURE
	NPC_CLASS_D_SECURITY_TEXTURE
	...
	NPC_CLASS_D_MAINTENANCE_TEXTURE
	NPC_CLASS_D_LOGISTICS_TEXTURE
	NPC_CLASS_D_HARN_TEXTURE
	NPC_CLASS_D_BODY_1_TEXTURE
	NPC_CLASS_D_BODY_2_TEXTURE
	NPC_CLASS_D_VICTIM_009_TEXTURE
	NPC_CLASS_D_VICTIM_035_TEXTURE
	NPC_CLASS_D_VICTIM_035_CORPSE_TEXTURE
	NPC_CLASS_D_VICTIM_106_TEXTURE
	NPC_CLASS_D_VICTIM_106_FEMUR_BREAKER_TEXTURE
	NPC_CLASS_D_VICTIM_409_TEXTURE
	NPC_CLASS_D_VICTIM_457_1_TEXTURE
	NPC_CLASS_D_VICTIM_457_2_TEXTURE
	NPC_CLASS_D_VICTIM_939_1_TEXTURE
	NPC_CLASS_D_VICTIM_939_2_TEXTURE
	NPC_CLASS_D_VICTIM_FEMUR_BREAKER_TEXTURE
	; ~ MTF
	NPC_MTF_LEADER_TEXTURE
	; ~ SCPs
	NPC_096_BLOODY_TEXTURE
	NPC_008_1_TEXTURE
	NPC_008_1_TEXTURE_2
	; ~ Clerk
	...
	While (Not Eof(f))
		...
		If Left(Loc, 1) = "["
			...
			If opt\BumpEnabled
				...
				If StrTemp <> ""
					mat\Bump = LoadTexture_Strict(StrTemp, 1 + 256, DeleteMapTextures)
...
Function LoadItems%()
	...
	CreateItemTemplate(GetLocalString("items", "doc457"), "Document SCP-457", it_paper, "paper.b3d", "INV_paper_bloody.png", "doc_457.png", 0.003, ITEM_SOUND_PAPER, "doc_457.png")
	...
	CreateItemTemplate(GetLocalString("items", "doc914log"), "Addendum: 5/14 Test Log", it_paper, "paper.b3d", "INV_paper.png", "doc_RAND(2).png", 0.003, ITEM_SOUND_PAPER, "doc_RAND(2).png")
	CreateItemTemplate(GetLocalString("items", "doccdol"), "Class D Orientation Leaflet", it_paper, "paper.b3d", "INV_paper.png", "doc_OL.png", 0.003, ITEM_SOUND_PAPER, "doc_OL.png")
	CreateItemTemplate(GetLocalString("items", "doc"), "Document", it_paper, "paper.b3d", "INV_paper.png", "doc_RAND(3).png", 0.003, ITEM_SOUND_PAPER, "doc_RAND(3).png")
	CreateItemTemplate(GetLocalString("items", "doco5"), "Field Agent Log #235-001-CO5", it_paper, "paper.b3d", "INV_paper.png", "doc_FAL.png", 0.003, ITEM_SOUND_PAPER, "doc_FAL.png")
	CreateItemTemplate(GetLocalString("items", "doco52"), "Groups of Interest Log", it_paper, "paper.b3d", "INV_paper.png", "doc_GOI.png", 0.003, ITEM_SOUND_PAPER, "doc_GOI.png")
	...
	CreateItemTemplate(GetLocalString("items", "docgears"), "Note from Gears", it_paper, "note.b3d", "INV_note.png", "note_Gears.png", 0.0025, ITEM_SOUND_PAPER, "note_Gears.png")
	...
	CreateItemTemplate(GetLocalString("items", "docst"), "Storage Transfers", it_paper, "paper.b3d", "INV_paper.png", "doc_storagetransfers.png", 0.003, ITEM_SOUND_PAPER, "doc_storagetransfers.png")
	...
	CreateItemTemplate(GetLocalString("items", "papn_1"), "Note From Nobody #1", it_paper, "paper.b3d", "INV_note.png", "note_Nobody(0).png", 0.0025, ITEM_SOUND_PAPER, "note_Nobody(0).png")
	CreateItemTemplate(GetLocalString("items", "papn_2"), "Note From Nobody #2", it_paper, "paper.b3d", "INV_note.png", "note_Nobody(1).png", 0.0025, ITEM_SOUND_PAPER, "note_Nobody(1).png")
	CreateItemTemplate(GetLocalString("items", "papn_3"), "Note From Nobody #3", it_paper, "paper.b3d", "INV_note.png", "note_Nobody(2).png", 0.0025, ITEM_SOUND_PAPER, "note_Nobody(2).png")
	CreateItemTemplate(GetLocalString("items", "papn_4"), "Note From Nobody #4", it_paper, "paper.b3d", "INV_note.png", "note_Nobody(3).png", 0.0025, ITEM_SOUND_PAPER, "note_Nobody(3).png")
	CreateItemTemplate(GetLocalString("items", "papn_5"), "Note From Nobody #5", it_paper, "paper.b3d", "INV_note.png", "note_Nobody(4).png", 0.0025, ITEM_SOUND_PAPER, "note_Nobody(4).png")
	CreateItemTemplate(GetLocalString("items", "papn_6"), "Note From Nobody #6", it_paper, "paper.b3d", "INV_note.png", "note_Nobody(5).png", 0.0025, ITEM_SOUND_PAPER, "note_Nobody(5).png")
	...
	CreateItemTemplate(GetLocalString("items", "doclog_1"), "Log #1", it_paper, "paper.b3d", "INV_note.png", "note_forest.png", 0.002, ITEM_SOUND_PAPER, "note_forest.png")
	CreateItemTemplate(GetLocalString("items", "doclog_2"), "Log #2", it_paper, "paper.b3d", "INV_note.png", "note_forest(2).png", 0.002, ITEM_SOUND_PAPER, "note_forest(2).png")
	CreateItemTemplate(GetLocalString("items", "doclog_3"), "Log #3", it_paper, "paper.b3d", "INV_note.png", "note_forest(3).png", 0.002, ITEM_SOUND_PAPER, "note_forest(3).png")
	...
	CreateItemTemplate(GetLocalString("items", "docnotemaynard"), "Note from Maynard", it_paper, "note.b3d", "INV_note.png", "note_Maynard(2).png", 0.0025, ITEM_SOUND_PAPER, "note_Maynard(2).png")
	CreateItemTemplate(GetLocalString("items", "docrand"), "Notification", it_paper, "paper.b3d", "INV_note.png", "doc_RAND.png", 0.003, ITEM_SOUND_PAPER, "doc_RAND.png")
	...
	CreateItemTemplate(GetLocalString("items", "oldbadge"), "Old Badge", it_badge, "badge.b3d", "INV_badge_D_9341.png", "badge_D_9341.png", 0.0001, ITEM_SOUND_PLASTIC, "badge_D_9341.png", "", False, 1 + 2 + 8)
	...
	; ~ [SCPs AND VARIATIONS]
	;[Block]
	CreateItemTemplate("SCP-005", "SCP-005", it_scp005, "scp_005.b3d", "INV_scp_005.png", "", 0.005, ITEM_SOUND_METAL)
	CreateItemTemplate("SCP-005", "Coarse SCP-005", it_coarse005, "scp_005.b3d", "INV_scp_005.png", "", 0.005, ITEM_SOUND_METAL)
	CreateItemTemplate("SCP-005", "Crystallized SCP-005", it_crystal005, "scp_005.b3d", "INV_scp_005_crystal.png", "", 0.005, ITEM_SOUND_METAL, "scp_005_crystal.png")
	
	CreateItemTemplate(GetLocalString("items", "148"), "SCP-148 Ingot", it_scp148ingot, "scp_148.b3d", "INV_scp_148.png", "", RoomScale, ITEM_SOUND_CLOTH)
	CreateItemTemplate(GetLocalString("items", "metalpanel"), "Metal Panel", it_scp148, "metal_panel.b3d", "INV_metal_panel.png", "", RoomScale, ITEM_SOUND_CLOTH)
	...
	CreateItemTemplate(GetLocalString("items", "cigarette"), "Cigarette", it_cigarette, "scp_420_j.b3d", "INV_scp_420_j.png", "", 0.00045, ITEM_SOUND_PAPER)
	...
	CreateItemTemplate("SCP-427", "SCP-427", it_scp427, "scp_427.b3d", "INV_scp_427.png", "", 0.001, ITEM_SOUND_METAL, "", "INV_scp_427_opened.png")
	CreateItemTemplate("SCP-500", "SCP-500", it_scp500, "scp_500.b3d", "INV_scp_500.png", "", 0.03, ITEM_SOUND_CLOTH, "", "", True)
	it.ItemTemplates = CreateItemTemplate("SCP-500-01", "SCP-500-01", it_scp500pill, "pill.b3d", "INV_scp_500_pill.png", "", 0.0003, ITEM_SOUND_CLOTH)
	EntityColor(it\OBJ, 255.0, 0.0, 0.0)
	it.ItemTemplates = CreateItemTemplate(GetLocalString("items", "500death"), "Upgraded Pill", it_scp500pilldeath, "pill.b3d", "INV_scp_500_pill.png", "", 0.0003, ITEM_SOUND_CLOTH)
	EntityColor(it\OBJ, 255.0, 0.0, 0.0)
	it.ItemTemplates = CreateItemTemplate(GetLocalString("items", "pill"), "Pill", it_pill, "pill.b3d", "INV_pill.png", "", 0.0003, ITEM_SOUND_CLOTH)
	EntityColor(it\OBJ, 255.0, 255.0, 255.0)
	
	CreateItemTemplate("SCP-513", "SCP-513", it_scp513, "scp_513.b3d", "INV_scp_513.png", "", 0.1, ITEM_SOUND_CLOTH)
	CreateItemTemplate("SCP-513", "Fine SCP-513", it_fine513, "scp_513.b3d", "INV_scp_513_no_rust.png", "", 0.1, ITEM_SOUND_CLOTH, "scp_513_no_rust.png")
	
	CreateItemTemplate("SCP-714", "SCP-714", it_scp714, "scp_714.b3d", "INV_scp_714.png", "", 0.2, ITEM_SOUND_METAL)
	CreateItemTemplate("SCP-714", "Coarse SCP-714", it_coarse714, "scp_714.b3d", "INV_scp_714_grey.png", "", 0.2, ITEM_SOUND_METAL, "scp_714_grey.png")
	CreateItemTemplate("SCP-714", "Fine SCP-714", it_fine714, "scp_714.b3d", "INV_scp_714_blue.png", "", 0.2, ITEM_SOUND_METAL, "scp_714_blue.png")
	CreateItemTemplate(GetLocalString("items", "ring"), "Green Jade Ring", it_ring, "scp_714.b3d", "INV_scp_714_small.png", "", 0.15, ITEM_SOUND_METAL)
	...
	it.ItemTemplates = CreateItemTemplate("SCP-2022-01", "SCP-2022-01", it_scp2022pill, "pill.b3d", "INV_scp_2022_pill.png", "", 0.0003, ITEM_SOUND_CLOTH)
	...
	CreateItemTemplate(GetLocalString("items", "eyedrops_2"), "Fine Eyedrops", it_fineeyedrops, "eye_drops.b3d", "INV_eye_drops.png", "", 0.0012, ITEM_SOUND_PLASTIC)
	CreateItemTemplate(GetLocalString("items", "eyedrops_2"), "Very Fine Eyedrops", it_veryfineeyedrops, "eye_drops.b3d", "INV_eye_drops.png", "", 0.0013, ITEM_SOUND_PLASTIC)
	...
	CreateItemTemplate(GetLocalString("items", "mask"), "Gas Mask", it_gasmask, "gas_mask.b3d", "INV_gas_mask.png", "", 0.019, ITEM_SOUND_CLOTH)
	CreateItemTemplate(GetLocalString("items", "mask"), "Fine Gas Mask", it_finegasmask, "gas_mask.b3d", "INV_gas_mask.png", "", 0.019, ITEM_SOUND_CLOTH)
	CreateItemTemplate(GetLocalString("items", "mask"), "Very Fine Gas Mask", it_veryfinegasmask, "gas_mask.b3d", "INV_gas_mask.png", "", 0.02, ITEM_SOUND_CLOTH)
	CreateItemTemplate(GetLocalString("items", "mask148"), "Heavy Gas Mask", it_gasmask148, "gas_mask.b3d", "INV_gas_mask_heavy.png", "", 0.02, ITEM_SOUND_CLOTH, "gas_mask_heavy.png")
	...
	CreateItemTemplate(GetLocalString("items", "suit"), "Hazmat Suit", it_hazmatsuit, "hazmat_suit.b3d", "INV_hazmat_suit.png", "", 0.013, ITEM_SOUND_CLOTH, "", "", True)
	CreateItemTemplate(GetLocalString("items", "suit"), "Fine Hazmat Suit", it_finehazmatsuit, "hazmat_suit.b3d", "INV_hazmat_suit.png", "", 0.013, ITEM_SOUND_CLOTH, "", "", True)
	CreateItemTemplate(GetLocalString("items", "suit"), "Very Fine Hazmat Suit", it_veryfinehazmatsuit, "hazmat_suit.b3d", "INV_hazmat_suit.png", "", 0.013, ITEM_SOUND_CLOTH, "", "", True)
	CreateItemTemplate(GetLocalString("items", "suit148"), "Heavy Hazmat Suit", it_hazmatsuit148, "hazmat_suit.b3d", "INV_hazmat_suit_heavy.png", "", 0.013, ITEM_SOUND_CLOTH, "hazmat_suit_heavy.png", "", True)
	
	CreateItemTemplate(GetLocalString("items", "nvg"), "Night Vision Goggles", it_nvg, "night_vision_goggles.b3d", "INV_night_vision_goggles_off.png", "", 0.02, ITEM_SOUND_CLOTH, "", "INV_night_vision_goggles_on_green.png")
	CreateItemTemplate(GetLocalString("items", "nvg"), "Fine Night Vision Goggles", it_finenvg, "night_vision_goggles.b3d", "INV_night_vision_goggles_off.png", "", 0.02, ITEM_SOUND_CLOTH, "", "INV_night_vision_goggles_on_red.png")
	CreateItemTemplate(GetLocalString("items", "nvg"), "Very Fine Night Vision Goggles", it_veryfinenvg, "night_vision_goggles.b3d", "INV_night_vision_goggles_off.png", "", 0.02, ITEM_SOUND_CLOTH, "", "INV_night_vision_goggles_on_blue.png")
	CreateItemTemplate(GetLocalString("items", "scramble"), "SCRAMBLE Gear", it_scramble, "SCRAMBLE_gear.b3d", "INV_SCRAMBLE_gear_off.png", "", 0.02, ITEM_SOUND_CLOTH, "", "INV_SCRAMBLE_gear_on.png")
	CreateItemTemplate(GetLocalString("items", "scramble"), "Fine SCRAMBLE Gear", it_finescramble, "SCRAMBLE_gear.b3d", "INV_SCRAMBLE_gear_off.png", "", 0.02, ITEM_SOUND_CLOTH, "", "INV_SCRAMBLE_gear_on.png")
	
	; ~ HUD texture is defined in "UpdateGUI"
	;[Block]
	CreateItemTemplate(GetLocalString("items", "radio"), "Radio Transceiver", it_radio, "radio.b3d", "INV_radio.png", "", 0.9, ITEM_SOUND_PLASTIC)
	CreateItemTemplate(GetLocalString("items", "radio"), "18V Radio Transceiver", it_18vradio, "radio.b3d", "INV_radio.png", "", 0.92, ITEM_SOUND_PLASTIC)
	CreateItemTemplate(GetLocalString("items", "radio"), "Fine Radio Transceiver", it_fineradio, "radio.b3d", "INV_radio.png", "", 0.9, ITEM_SOUND_PLASTIC)
	CreateItemTemplate(GetLocalString("items", "radio"), "Very Fine Radio Transceiver", it_veryfineradio, "radio.b3d", "INV_radio.png", "", 0.9, ITEM_SOUND_PLASTIC)
	
	CreateItemTemplate(GetLocalString("items", "nav"), "S-NAV 300", it_nav, "navigator.b3d", "INV_navigator.png", "", 0.00072, ITEM_SOUND_PLASTIC)
	...
	CreateItemTemplate(GetLocalString("items", "45bat"), "4.5V Battery", it_coarsebat, "battery.b3d", "INV_battery_4.5v.png", "", 0.0065, ITEM_SOUND_PLASTIC, "battery_4.5V.png")
	CreateItemTemplate(GetLocalString("items", "18bat"), "18V Battery", it_finebat, "battery.b3d", "INV_battery_18v.png", "", 0.0075, ITEM_SOUND_PLASTIC, "battery_18V.png")
	CreateItemTemplate(GetLocalString("items", "999bat"), "999V Battery", it_veryfinebat, "battery.b3d", "INV_battery_999v.png", "", 0.007, ITEM_SOUND_PLASTIC, "battery_999V.png")
	CreateItemTemplate(GetLocalString("items", "killbat"), "Strange Battery", it_killbat, "battery.b3d", "INV_strange_battery.png", "", 0.007, ITEM_SOUND_PLASTIC, "strange_battery.png")
	
	CreateItemTemplate(GetLocalString("items", "syringe"), "Syringe", it_syringe, "syringe.b3d", "INV_syringe.png", "", 0.005, ITEM_SOUND_CLOTH)
	CreateItemTemplate(GetLocalString("items", "syringe"), "Fine Syringe", it_finesyringe, "syringe.b3d", "INV_syringe.png", "", 0.005, ITEM_SOUND_CLOTH)
	CreateItemTemplate(GetLocalString("items", "syringe"), "Very Fine Syringe", it_veryfinesyringe, "syringe.b3d", "INV_syringe.png", "", 0.005, ITEM_SOUND_CLOTH)
	CreateItemTemplate(GetLocalString("items", "syringe"), "Infected Syringe", it_syringeinf, "syringe.b3d", "INV_syringe_infect.png", "", 0.005, ITEM_SOUND_CLOTH, "syringe_infect.png")
	;[End Block]
	...
	CreateItemTemplate(GetLocalString("items", "mastercard"), "Mastercard", it_mastercard_golden, "key_card.b3d", "INV_master_card_golden.png", "", 0.00037, ITEM_SOUND_PLASTIC, "master_card_golden.png")
	...
	CreateItemTemplate(GetLocalString("items", "key.simple"), "White Key", it_key_white, "key.b3d", "INV_key.png", "", 0.0027, ITEM_SOUND_METAL)
	CreateItemTemplate(GetLocalString("items", "key"), "Lost Key", it_lostkey, "key.b3d", "INV_lost_key.png", "", 0.0027, ITEM_SOUND_METAL, "lost_key.png")
	...
	CreateItemTemplate(GetLocalString("items", "25ct"), "Quarter", it_25ct, "coin.b3d", "INV_coin.png", "", 0.0004, ITEM_SOUND_METAL)
	CreateItemTemplate(GetLocalString("items", "coin"), "Coin", it_coin, "coin.b3d", "INV_coin_rusty.png", "", 0.0004, ITEM_SOUND_METAL, "coin_rusty.png")
...
Enum NPCSounds
	SOUND_NPC_MTF_BEEP
	SOUND_NPC_MTF_BREATH
	SOUND_NPC_MTF_BLINKING
	SOUND_NPC_008_1_BREATH
	SOUND_NPC_035_TENTACLE_IDLE
	SOUND_NPC_049_BREATH
	SOUND_NPC_049_2_BREATH
	SOUND_NPC_049_2_RESTING
	SOUND_NPC_457_FIRE
	SOUND_NPC_457_SIGHTING
	SOUND_NPC_VEHICLE_IDLE
	SOUND_NPC_VEHICLE_MOVING
	SOUND_NPC_APACHE_PROPELLER
End Enum
...
Enum OverlayTextureID
	OVERLAY_TEXTURE_VIGNETTE
	OVERLAY_TEXTURE_NVG
	OVERLAY_TEXTURE_DARK
	OVERLAY_TEXTURE_TESLA
End Enum
...
Enum ImageID
	IMAGE_PAUSE_MENU
	IMAGE_BLINK_METER_2
	IMAGE_STAMINA_METER_1
	IMAGE_STAMINA_METER_2
	IMAGE_294_PANEL
	IMAGE_NVG_BATTERIES
End Enum
...
Function InitNewGame%()
	...
	Repeat CODE_DR_MAYNARD = Rand(1000, 9990)
	Until CODE_DR_MAYNARD <> CODE_DR_HARP And CODE_DR_MAYNARD <> CODE_CONT1_035 And CODE_DR_MAYNARD <> CODE_DR_L
	
	Repeat CODE_CMR = Rand(1000, 9990)
	Until CODE_CMR <> CODE_DR_HARP And CODE_CMR <> CODE_CONT1_035 And CODE_CMR <> CODE_DR_L And CODE_CMR <> CODE_DR_MAYNARD
	
	Repeat CODE_MAINTENANCE_TUNNELS = Rand(1000, 9990)
	Until CODE_MAINTENANCE_TUNNELS <> CODE_DR_HARP And CODE_MAINTENANCE_TUNNELS <> CODE_CONT1_035 And CODE_MAINTENANCE_TUNNELS <> CODE_DR_L And CODE_MAINTENANCE_TUNNELS <> CODE_DR_MAYNARD And CODE_MAINTENANCE_TUNNELS <> CODE_CMR
	
	Repeat CODE_DR_GEARS = Rand(1000, 9990)
	Until CODE_DR_GEARS <> CODE_DR_HARP And CODE_DR_GEARS <> CODE_CONT1_035 And CODE_DR_GEARS <> CODE_DR_L And CODE_DR_GEARS <> CODE_DR_MAYNARD And CODE_DR_GEARS <> CODE_CMR And CODE_DR_GEARS <> CODE_MAINTENANCE_TUNNELS
